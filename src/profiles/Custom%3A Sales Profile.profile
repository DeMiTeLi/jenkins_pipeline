...
<Profile xmlns="http://soap.sforce.com/2006/04/metadata">
    ...
    <layoutAssignments>
        <layout>CaseMilestone-Макет контрольной точки обращения</layout>
    </layoutAssignments>
    <layoutAssignments>
    ...
    <layoutAssignments>
        <layout>ContractLineItem-Макет элемента строки контракта</layout>
    </layoutAssignments>
    <layoutAssignments>
    ...
    <layoutAssignments>
        <layout>Entitlement-Макет права</layout>
    </layoutAssignments>
    <layoutAssignments>
        <layout>EntityMilestone-Макет контрольной точки объекта</layout>
    </layoutAssignments>
    <layoutAssignments>
    ...
    <layoutAssignments>
        <layout>ServiceContract-Макет сервисного контракта</layout>
    </layoutAssignments>
    <layoutAssignments>
